...
data = []
for line in open('Data/lyrics_new.txt'):
  line = line.rstrip()
...
tokenizer = Tokenizer(num_words=MAX_VOCAB_SIZE, filters='') # filters='' ensures that special characters like <sos> are not filtered out
